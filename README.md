...
产物：`build/libs/inf_farlands-1.0.2.jar`

## 特性

将游戏在 x/z 轴上的边界推至 ±2,147,483,647 格，同时尽量保证游戏的正常运行。

本模组尽量地修复了地物、实体、光照在高坐标下的行为。
...
模组内有一个非核心功能的 Java Agent，对结构生成有一定帮助。若您想要启用它，请增加一个 JVM 参数： `-javaagent:inf_farlands-1.0.2.jar`。
