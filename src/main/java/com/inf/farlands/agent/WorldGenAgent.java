...
class BoundingBoxTransformer implements ClassFileTransformer {
    ...
    public byte[] transform(
            ...
            ProtectionDomain pd,
            byte[] buf) {
        if (!"net/minecraft/world/level/levelgen/structure/BoundingBox".equals(className)) {
            return buf;
        }
        System.out.println(
                "[InfFarlands Agent] Patching net/minecraft/world/level/levelgen/structure/BoundingBox.<init>");
                ...
                new ClassVisitor(Opcodes.ASM9, cw) {
                    ...
                    public MethodVisitor visitMethod(
                        ...
                        MethodVisitor mv = super.visitMethod(
                                ...
                                sig,
                                exs);
                        if (name.equals("<init>") && desc.equals("(IIIIII)V")) {
