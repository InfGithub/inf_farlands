...
/**
 * vanilla 1.21.1 主世界群系系统：MultiNoiseBiomeSource 原版布局。
 *
 * fillBiomes 用维度 generator 的 biomeSource + RandomState 的 Climate.Sampler
 * （6 通道：temperature/vegetation/continents/erosion/depth/ridges），对 fill 段内
 * 每 section 填 4×4×4 biome 网格（LevelChunkSection.fillBiomesFromNoise 原版方法）。
 *
