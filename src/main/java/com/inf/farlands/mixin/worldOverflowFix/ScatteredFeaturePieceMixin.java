...
/**
 * 极端 XZ 结构（沙漠神殿等 ScatteredFeature）postProcess 时
 ...
 * k <= maxX; k++) 的 k++ 溢出回绕 → 无限循环（worldgen 满核冻结，l6.log
 * 2026-08-23；#36/#38 同族，spec #16；#39 的 fromCorners clamp 不覆盖
 * makeBoundingBox 创建的 box）。
 *
 ...
 * 覆盖所有 ScatteredFeature 结构（沙漠神殿/丛林神庙/女巫小屋等共用此方法）。
 */
